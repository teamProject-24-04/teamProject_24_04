...
<div style={{ display: 'flex' }}> {/* 가로로 나열되는 플렉스 컨테이너 */}
<Box
  height={130}
  width={190}
  backgroundColor='#ACB9D1'
  ...
  borderRadius={1}
>
  <div style={{ marginTop: '7px' }}> {/* 첫 번째 내용과 간격 */}
    내 게시글 바로가기
    <FaPlus style={{ marginLeft: '30px', color: '#538DFF' }} />
  </div>
  <div style={{ marginTop: '13px', fontWeight: 'bold' }}> {/* 두 번째 내용과 간격 */}
    35개
  </div>
  <div style={{ marginTop: '7px' }}> {/* 세 번째 내용과 간격 */}
    내 댓글 바로가기
    <FaPlus style={{ marginLeft: '45px', color: '#538DFF' }} />
  </div>
  <div style={{ marginTop: '13px', fontWeight: 'bold' }}> {/* 네 번째 내용과 간격 */}
    35개
  </div>
</Box>
<Box
...
>
  <div style={{ marginTop: '7px' }}> {/* 첫 번째 내용과 간격 */}
    ...
    <FiShoppingCart style={{ fontSize: '50px', marginTop: '20px', marginLeft:'60px' }} /> {/* 아이콘 크기 조절 및 위치 조정 */}
  <div style={{ marginTop: '5px', fontWeight: 'bold', textAlign:'right'}}> {/* 네 번째 내용과 간격 */}
    3개
  </div>
</Box>
</div>
...
<Box
  ...
  borderRadius={1}
>
  <div style={{ marginTop: '7px', marginLeft: '7px', display:'flex' }}> {/* 첫 번째 내용과 간격 */}
    찜한 목록
    <FaPlus style={{ marginLeft: '290px', color: '#538DFF' }} />
  </div>
  <div style={{ marginTop: '20px', marginLeft: '7px', display:'flex' }}> {/* 첫 번째 내용과 간격 */}
    찜한 유튜버
